...
export function ContactModified() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const mailSubject = encodeURIComponent(subject || 'New Contact Message');
        ...
        const mailto = `mailto:${TO_EMAIL}?cc=${email}&subject=${mailSubject}&body=${body}`;
