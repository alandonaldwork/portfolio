...
const PinnedScrollAnimation: React.FC = () => {
    ...
    useEffect(() => {
        ...
        // 5) White wipe expands horizontally
        // tl.to(
        //     whiteWipe,
        //     {
        //         scaleX: 1,
            ...
            <div className="content text-center">
                <h1
                    ...
                    dangerouslySetInnerHTML={{
                        __html: "Scroll to Explore, Projects That Speak",
                    }}
                />
            </div>
            {/* <div className="white-wipe bg-primary"></div> */}
        </section>
    );
};
